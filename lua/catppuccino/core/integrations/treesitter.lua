...
function M.get(cpt)
	return {
		...
		TSConstBuiltin = { fg = cpt.orange_br, style = cpc.styles.keywords }, -- For constant that are built in the language: `nil` in Lua.
		-- TSConstMacro        = { };    -- For constants that are defined by macros: `NULL` in cpt.
		-- TSError             = { };    -- For syntax/parser errors.
		TSException = { fg = cpt.magenta_br, style = cpc.styles.keywords }, -- For exception related keywords.
		...
		TSRepeat = { fg = cpt.red, style = cpc.styles.keywords }, -- For keywords related to loops.
		...
		-- TSType              = { };    -- For types.
		TSTypeBuiltin = { fg = cpt.cyan, style = cpc.styles.keywords }, -- For builtin types.
		TSVariable = { style = cpc.styles.variables }, -- Any variable name that does not have another highlighcpt.
		TSVariableBuiltin = { fg = cpt.red, style = cpc.styles.keywords }, -- Variable names that are defined by the languages, like `this` or `self`.
