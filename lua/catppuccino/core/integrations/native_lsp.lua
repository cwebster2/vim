...
function M.get(cpt)
	...
	return {
		...
		-- documentation.
		LspReferenceText = { bg = cpt.bg_visual }, -- used for highlighting "text" references
		LspReferenceRead = { bg = cpt.bg_visual }, -- used for highlighting "read" references
		LspReferenceWrite = { bg = cpt.bg_visual }, -- used for highlighting "write" references
